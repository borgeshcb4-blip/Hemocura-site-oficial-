    ...
    <>
      ...
      <div className="fixed bottom-0 left-0 w-full bg-white border-t border-gray-100 p-4 z-40 shadow-[0_-4px_20px_rgba(0,0,0,0.05)]">
        <div className="max-w-md mx-auto">
          <button className="relative w-full bg-[#10b981] hover:bg-[#059669] active:scale-[0.98] transition-all duration-200 text-white rounded-xl py-4 px-6 flex items-center justify-center gap-2 shadow-lg shadow-emerald-200 overflow-hidden">
